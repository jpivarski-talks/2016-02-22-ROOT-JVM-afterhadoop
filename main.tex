...
\item {\bf JNAerator} generates bindings for {\bf JNA}, may be used with {\bf JNA} or {\bf BridJ}.
\begin{itemize}
...
\item Also might use {\tt TProcess::Declare} (ROOT's version of Scala macros).

\item Want to include objects, possibly CMS's FWLite.
\begin{itemize}
\item Can {\bf JNAerator} manage it? Maybe a simplified form?
\end{itemize}
\end{itemize}
\end{frame}
