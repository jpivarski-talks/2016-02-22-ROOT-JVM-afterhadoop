...
\item Spark could only use my Hadoop InputFormat if it was precompiled in a JAR, not on the commandline, dramatically changing Spark user experience (fixable).
