...
\begin{itemize}
\item {\bf FreeHEP-ROOTIO} (pure-Java reimplementation)
\begin{itemize}
...
\item Native bridge
\begin{itemize}
\item Java's built-in {\bf JNI} requires some care (always segmentation faults for me).
...
\item Segmentation faults rarely (and randomly). Haven't been able to find cause.
\end{itemize}
