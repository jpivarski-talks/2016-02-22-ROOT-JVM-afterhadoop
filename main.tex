...
\item {\bf JNAerator} (generates bindings for {\bf JNA}): attempt to convert ROOT's header files to Java, spent 100\% of 36 CPUS for 3 hours before giving up.
\item Worst case: external process piping Avro data. (I've done it before.)
\end{itemize}
