...
\begin{itemize}
\item FreeHEP-ROOTIO (pure-Java reimplementation of ROOT I/O)
\begin{itemize}
...
\item However, {\tt RootFileReader} requires a file on disk, which limits usefulness. ({\tt java.net.URL} constructor doesn't accept {\tt http://})
\end{itemize}
